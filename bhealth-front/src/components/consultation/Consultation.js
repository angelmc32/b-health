                        ...
                        <div className="uk-modal-dialog uk-margin-auto-vertical">
                          ...
                          <div className="uk-modal-body uk-padding-small uk-flex uk-flex-column uk-flex-middle">
                            ...
                            { consultation.studies.length > 0 ? (
                                <button className="uk-modal-close uk-button uk-button-default uk-border-pill uk-margin-small uk-width-4-5 uk-width-1-2@s" onClick={event => push({pathname: `${url}/estudios`, state: {consultation: consultation} }) } >
                                  Ver Estudios
                                </button>
                              ) : (
                                <Fragment>
