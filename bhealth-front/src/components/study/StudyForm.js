    ...
    <form onSubmit={handleSubmit} className="uk-form-stacked uk-text-left">
      <div className="uk-margin">
        ...
        <div className="uk-margin">
          ...
          <div className="uk-form-controls">
            <input className="uk-input uk-border-pill" type="text" name="study_name" onChange={handleInput} placeholder="Nombre del estudio..." />
          </div>
          <label className="uk-form-label" htmlFor="form-stacked-text">Nombre de Laboratorio:</label>
          <div className="uk-form-controls">
            <input className="uk-input uk-border-pill" type="text" name="facility_name" onChange={handleInput} placeholder="Dónde se realizó los estudios" />
          </div>
